...
var imagenes = [['https://i.ytimg.com/vi/vB8DgjEcGRI/maxresdefault.jpg', 'Cráter El Elegante, Sierra del Pinacate, Sonora'],
    ...
    ["http://www.alertatierra.com/images/thumbnails/images/LaReforma-fit-330x195.jpg", 'La Caldera La Reforma, Isla San Luis, Península de Baja California Sur.'],
...
var geojsonLayer = L.geoJson(sismos, {
    onEachFeature: function (feature, layer) {
        layer.bindPopup('<h1>' + "Magnitud:" + feature.properties.Magnitud + '</h1>');
    },
